...
function AnimatedCounter({ target, suffix = "" }: { target: string; suffix?: string }) {
  ...
  return (
    <div ref={ref}>
      <span className="tabular-nums">{count}{target.includes("+") ? "+" : ""}{suffix}</span>
    </div>
  );
}
      ...
      <main className="overflow-hidden bg-white text-slate-800">
        ...
        <section ref={heroRef} className="relative flex min-h-[100vh] items-center overflow-hidden">
          <motion.div style={{ y: heroY, scale: heroScale }} className="absolute inset-0">
            ...
            <div className="animate-float-slow absolute -right-40 -top-40 h-[700px] w-[700px] rounded-full bg-turquoise/20 blur-[150px]" />
            <div className="animate-float-slower absolute -bottom-32 left-1/4 h-[500px] w-[500px] rounded-full bg-orange/12 blur-[120px]" />
            <div className="animate-pulse-glow absolute left-10 top-1/3 h-[300px] w-[300px] rounded-full bg-turquoise-light/10 blur-[100px]" />
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            />
            <motion.div
              animate={{ y: [15, -25, 15], rotate: [0, -8, 0] }}
              transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
              className="absolute right-[8%] top-[55%] h-16 w-16 rounded-xl border border-orange/20 bg-orange/5 backdrop-blur-sm"
            />
            <motion.div
              animate={{ y: [10, -15, 10] }}
            ...
            <motion.div
              ...
              className="absolute right-[20%] top-[35%] h-2 w-2 rounded-full bg-orange/50"
            />
          </div>

          <motion.div style={{ opacity: heroOpacity }} className="relative mx-auto w-full max-w-7xl px-6 py-32">
        ...
        <section className="relative overflow-hidden bg-navy-dark px-6 py-28">
          <NoiseOverlay />
          <div className="animate-float-slow absolute -left-48 top-1/2 h-[600px] w-[600px] -translate-y-1/2 rounded-full bg-turquoise/8 blur-[140px]" />
          <div className="animate-float-slower absolute -right-24 bottom-0 h-[400px] w-[400px] rounded-full bg-orange/6 blur-[100px]" />
        ...
        <section className="relative overflow-hidden bg-navy-dark px-6 py-28">
          <NoiseOverlay />
          <div className="animate-float-slow absolute -right-40 -top-40 h-[600px] w-[600px] rounded-full bg-turquoise/12 blur-[160px]" />
          <div className="animate-float-slower absolute -left-24 bottom-0 h-[400px] w-[400px] rounded-full bg-orange/8 blur-[120px]" />
          <div
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="grid items-start gap-14 lg:grid-cols-2">
              ...
              <InView delay={0.15}>
                <form className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.03] p-9 backdrop-blur-xl">
                  <NoiseOverlay />
                  ...
                  <div className="relative mt-7 space-y-4">
                    ...
                    <button
                      type="submit"
                      className="group flex w-full items-center justify-center gap-2.5 rounded-xl bg-gradient-to-r from-orange to-orange-light px-6 py-4 font-bold text-white shadow-lg shadow-orange/25 transition-all duration-400 hover:shadow-glow-orange hover:shadow-2xl"
                    >
