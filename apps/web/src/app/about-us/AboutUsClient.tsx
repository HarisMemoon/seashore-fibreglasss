...
const SERVICE_AREA_DETAILS = [
  ...
  },
  {
    ...
    challenge:
      "Boardwalk-adjacent wear and heavy turnover in rental properties.",
  },
  {
  ...
  },
  {
    ...
    challenge:
      "Beachfront conditions with high expectations for finish quality.",
  },
  {
    town: "Longport NJ",
    slug: "longport-nj",
    challenge:
      "Elevated waterfront decks that demand premium waterproofing detail.",
  },
  {
    town: "Strathmere NJ",
    slug: "strathmere-nj",
  ...
  },
  {
    ...
    slug: "wildwood-nj",
    challenge:
      "High tourist traffic, boardwalk exposure, and rental durability needs.",
  },
  {
    town: "Cape May NJ",
    slug: "cape-may-nj",
...
const DIFF_ICONS = [
  ...
  >
    <path
      fillRule="evenodd"
      d="M9.661 2.237a.531.531 0 01.678 0 11.947 11.947 0 007.078 2.749.5.5 0 01.479.425c.069.52.104 1.05.104 1.589 0 5.162-3.26 9.563-7.834 11.256a.48.48 0 01-.332 0C5.26 16.563 2 12.162 2 7c0-.539.035-1.069.104-1.589a.5.5 0 01.48-.425 11.947 11.947 0 007.077-2.749zm4.196 5.954a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"
      clipRule="evenodd"
    />
  </svg>,
  /* 50+ Reviews — star */
  ...
  <svg
    ...
    aria-hidden
  >
    <path d="M1 8.25a1.25 1.25 0 112.5 0v7.5a1.25 1.25 0 11-2.5 0v-7.5zM11 3V1.7c0-.268.14-.526.395-.607A2 2 0 0114 3c0 .995-.182 1.948-.514 2.826-.204.54.166 1.174.744 1.174h2.52c1.243 0 2.261 1.01 2.146 2.247a23.864 23.864 0 01-1.341 5.974C17.153 16.323 16.072 17 14.9 17H8.053c-1.013 0-1.853-.776-1.853-1.789V8.997c0-.806.445-1.527 1.097-2.01L11 3z" />
  </svg>,
...
function SectionLabel({
  ...
  return (
    <span
      className={`inline-flex items-center gap-2.5 text-[11px] font-bold uppercase tracking-[0.2em] ${light ? "text-turquoise-light" : "text-turquoise"}`}
    >
      <span
        className={`h-px w-10 bg-gradient-to-r ${light ? "from-turquoise-light to-turquoise-light/0" : "from-turquoise to-turquoise/0"}`}
      />
      {children}
    </span>
  );
  ...
  return (
    <main className="overflow-hidden bg-white text-slate-800">
      ...
      <section className="relative flex min-h-[80vh] items-center overflow-hidden bg-navy-dark px-6 pb-20 pt-28 md:pb-28 md:pt-32">
        ...
        <div
          className="absolute -left-16 bottom-0 h-[300px] w-[300px] rounded-full bg-orange/8 blur-[80px]"
          style={{ animation: "float 9s ease-in-out infinite 1.5s" }}
        />
        <div
          className="absolute left-1/2 top-1/3 h-[200px] w-[200px] -translate-x-1/2 rounded-full bg-turquoise/8 blur-[70px]"
          style={{ animation: "float 7s ease-in-out infinite 3s" }}
        />
        <NoiseOverlay />
            ...
            >
              {HERO_STATS.map((stat) => (
                ...
                >
                  ...
                  <p className="mt-0.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-white/50">
                    {stat.label}
                  </p>
                </div>
              ))}
            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1B3A5C] via-[#0d3a5c] to-[#060e18] p-8 shadow-xl">
                ...
                <div className="relative">
                  {/* Quote mark */}
                  <div className="font-heading text-6xl font-black leading-none text-turquoise/20">
                    &ldquo;
                  </div>
                  <p className="mt-2 text-lg font-medium leading-relaxed text-white/80 italic">
                    We stay because homeowners on the Shore deserve contractors
                    who treat every deck like it protects real living space
                    underneath — because it does.
                  </p>
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={badge}
                        className="rounded-full border border-white/15 bg-white/5 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.16em] text-white/60"
                      >
                        {badge}
                      </span>
                    ))}
            ...
            {ABOUT_DIFFERENTIATORS.map((item, i) => {
              ...
              const inner = (
                <>
                  {/* Top color bar */}
                  <div
                    className={`absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-turquoise via-turquoise-light to-orange transition duration-300 ${isActive ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}
                  />

                  {/* Number watermark */}
                  <div
                    className={`absolute right-4 top-4 font-heading text-5xl font-black leading-none transition duration-300 ${isActive ? "text-turquoise/20" : "text-turquoise/10"}`}
                  >
                  ...
                  {/* Icon */}
                  <div
                    className={`inline-flex h-10 w-10 items-center justify-center rounded-xl transition duration-300 ${isActive ? "bg-turquoise text-white" : "bg-turquoise/10 text-turquoise group-hover:bg-turquoise group-hover:text-white"}`}
                  >
                    {DIFF_ICONS[i]}
                  </div>

                  <h3
                    className={`font-heading mt-4 text-xl font-bold transition duration-300 ${isActive ? "text-turquoise" : "text-navy group-hover:text-turquoise"}`}
                  >
                    {item.title}
                    {isGbp && (
                      <svg
                        className="ml-1.5 inline-block h-4 w-4 -translate-y-0.5 text-turquoise"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden
                ...
                >
                  {isGbp ? (
                    ...
                    <div
                      ...
                      tabIndex={0}
                      onKeyDown={(e) =>
                        e.key === "Enter" && setActiveCard(isActive ? null : i)
                      }
      ...
      <section className="border-y border-slate-100 bg-slate-50 px-6 py-16 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="font-heading mt-4 text-3xl font-bold text-navy md:text-4xl">
              How We Engineer for Coastal Exposure
            </h2>
            <p className="mt-5 max-w-3xl text-lg leading-relaxed text-slate-600">
              Our system standards are designed for salt air, high humidity,
              intense UV, and freeze-thaw cycles seen across the South Jersey
              Shore.
            </p>
          </motion.div>
            ...
            {SHORE_SYSTEM_STANDARDS.map((item) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4">
                  <p className="text-xs font-bold uppercase tracking-[0.14em] text-turquoise">
                    {item.label}
                  </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-slate-500">
              ...
              {filteredAreas.length === 1 ? "town" : "towns"}
            </span>
          </div>
          ...
          >
            {filteredAreas.length === 0 ? (
              <p className="col-span-full py-8 text-center text-slate-400">
                No towns match &ldquo;{areaSearch}&rdquo;
              </p>
            ) : (
              filteredAreas.map((area) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <h3 className="font-heading text-lg font-bold text-navy transition duration-300 group-hover:text-turquoise">
                      {area.town}
                    </h3>
      ...
      {/* ══════════════════ CONNECT WITH US ══════════════════ */}
      <section className="border-t border-slate-100 bg-white px-6 py-16 md:py-24">
        <div className="mx-auto max-w-7xl">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            variants={fadeUp}
          >
            <SectionLabel>Find us online</SectionLabel>
            <h2 className="font-heading mt-4 text-3xl font-bold text-navy md:text-4xl">
              Connect With Us & Verify Our Reputation
            </h2>
            <p className="mt-5 max-w-3xl text-lg leading-relaxed text-slate-600">
              See real projects, read verified homeowner reviews, and follow our
              work across the Shore — on every platform where we share our
              story.
            </p>
          </motion.div>
          ...
          >
            {SOCIAL_PLATFORMS.map((platform) => (
              <motion.a
                ...
                rel="noopener noreferrer"
                variants={cardVariant}
                className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-br from-white to-slate-50 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-turquoise/40 hover:shadow-xl"
              >
                {/* Top accent bar */}
                <div className="absolute inset-x-0 top-0 h-1 origin-left scale-x-0 rounded-t-2xl bg-gradient-to-r from-turquoise via-turquoise-light to-orange transition-transform duration-300 group-hover:scale-x-100" />

                {/* Watermark number */}
                <div className="pointer-events-none absolute right-4 top-4 font-heading text-5xl font-black leading-none text-turquoise/[0.07] transition-colors duration-300 group-hover:text-turquoise/[0.12]">
                  {String(SOCIAL_PLATFORMS.indexOf(platform) + 1).padStart(
                    2,
                    "0",
                  )}
                </div>
                ...
                {/* Icon */}
                <div className="relative inline-flex h-12 w-12 items-center justify-center rounded-xl bg-navy text-white shadow-lg shadow-navy/20 transition-all duration-300 group-hover:bg-gradient-to-br group-hover:from-turquoise group-hover:to-turquoise-dark group-hover:shadow-turquoise/30">
                  <span className="h-5 w-5">{platform.icon}</span>
                </div>

                {/* Text */}
                <h3 className="font-heading mt-4 text-xl font-bold text-navy transition-colors duration-300 group-hover:text-turquoise-dark">
                  {platform.label}
                </h3>
                ...
                {/* CTA */}
                <span className="mt-5 inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.16em] text-turquoise transition-all duration-300 group-hover:gap-2.5 group-hover:text-turquoise-dark">
                  Follow us
                  <svg
      ...
      >
        ...
        <div
          className="absolute -bottom-16 -left-16 h-56 w-56 rounded-full bg-orange/8 blur-[70px]"
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          ...
          >
            <h2 className="font-heading text-2xl font-bold text-white md:text-3xl">
              Ready for an honest deck assessment?
            </h2>
            <p className="mt-3 max-w-xl text-white/65">
              Free inspections, clear technical answers, and no pressure — the
              way we have built our reputation since 2020.
            </p>
          </motion.div>
